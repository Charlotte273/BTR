# -*- coding: utf-8 -*-
"""
Created on Fri Jul 14 13:05:11 2023
...
def objective(x0, c_ddr, data_exp, f_avg, substance): #data_exp is the data of sheet_name. it has the two dictionaries DOwnstream sorbent and Waste
    V_waste = 0 #ml
